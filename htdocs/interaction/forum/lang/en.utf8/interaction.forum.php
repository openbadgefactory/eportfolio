...
$string['activetopicsdescription'] = 'Recently updated topics in your team work spaces.';
...
$string['autosubscribeusersdescription'] = 'Choose whether team work space users will automatically be subscribed to this forum';
...
$string['cantviewforums'] = 'You are not allowed to view forums in this team work space';
...
$string['closeddescription'] = 'Closed topics can only be replied to by moderators and the team work space administrators';

$string['closetopics'] = 'Close new topics';

$string['closetopicsdescription'] = 'If checked, all new topics in this forum will be closed by default. Only moderators and team work space administrators can reply to closed topics.';

$string['createtopicusersdescription'] = 'If set to "All team work space members", anyone can create new topics and reply to existing topics. If set to "Moderators and team work space administrators", only moderators and team work space administrators can start new topics, but once topics exist, all users can post replies to them.';
...
$string['groupadminlist'] = 'Team work space administrators:';

$string['groupadmins'] = 'Team work space administrators';
...
$string['moderatorsandgroupadminsonly'] = 'Moderators and team work space administrators only';
...
$string['noforumpostsyet'] = 'There are no posts in this team work space yet';

$string['noforums'] = 'There are no forums in this team work space';
...
$string['topicisclosed'] = 'This topic is closed. Only moderators and the team work space administrators can post new replies.';
