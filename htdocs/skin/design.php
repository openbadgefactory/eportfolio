...
$fromviewskin = param_alpha('from', null); //< EKAMPUS>
...
$elements['viewheader'] = array(
        ...
        'elements'     => array(
                ...
                'header_link_normal_color' => array(
                        ...
                        'defaultvalue' => (!empty($viewskin['header_link_normal_color']) ? $viewskin['header_link_normal_color'] : '#285375'),
                        'size' => 7,
                        'options' => array(
                            'transparent' => true,
                        ),
                ...
                'header_link_hover_color' => array(
                        ...
                        'defaultvalue' => (!empty($viewskin['header_link_hover_color']) ? $viewskin['header_link_hover_color'] : '#00AE4C'),
                        'size' => 7,
                        'options' => array(
                            'transparent' => true,
                        ),
...
$elements['viewcontent'] = array(
        ...
        'elements'     => array(
                ...
                'view_text_heading_color' => array(
                        ...
                        'defaultvalue' => (!empty($viewskin['view_text_heading_color']) ? $viewskin['view_text_heading_color'] : '#027499'),
                        'size' => 7,
                        'options' => array(
                            'transparent' => true,
                        ),
                ...
                'view_link_normal_color' => array(
                        'type' => 'color',
                        'title' => get_string('normallinkcolor', 'skin'),
                        'defaultvalue' => (!empty($viewskin['view_link_normal_color']) ? $viewskin['view_link_normal_color'] : '#285375'),
                        'size' => 7,
                        'options' => array(
                            'transparent' => true,
                        ),
                ...
                'view_link_hover_color' => array(
                        'type' => 'color',
                        'title' => get_string('hoverlinkcolor', 'skin'),
                        'defaultvalue' => (!empty($viewskin['view_link_hover_color']) ? $viewskin['view_link_hover_color'] : '#00AE4C'),
                        'size' => 7,
                        'options' => array(
                            'transparent' => true,
                        ),
...
$elements['viewtable'] = array(
        ...
        'elements'     => array(
                ...
                'view_button_normal_color' => array(
                        ...
                        'defaultvalue' => (!empty($viewskin['view_button_normal_color']) ? $viewskin['view_button_normal_color'] : '#028FD1'),
                        'options' => array(
                            'transparent' => true,
                        ),
                ),
                'view_button_hover_color' => array(
                        ...
                        'defaultvalue' => (!empty($viewskin['view_button_hover_color']) ? $viewskin['view_button_hover_color'] : '#074765'),
                        'options' => array(
                            'transparent' => true,
                        ),
                ),
...
$elements['submit'] = array(
        'type' => 'submitcancel',
        // <EKAMPUS
        'value' => array(get_string('done', 'mahara'), get_string('cancel', 'mahara')),
...
$css = array(
    ...
    '<link rel="stylesheet" type="text/css" href="' . get_config('wwwroot') . 'local/css/bootstrap.css"></link>',
);
$smarty = smarty(array('jquery', 'tabs'), $css, array(
    'mahara' => array(
        'tab',
        'selected',
    ),
...
function designskinform_submit(Pieform $form, $values) {
    global $USER, $SESSION, $redirect, $fromviewskin; //<EKAMPUS>
...
function designskinform_cancel_submit() {
    global $redirect, $fromviewskin;
    $javascript = <<<EOF
        parent.location.reload('true');
EOF;
    if ($fromviewskin == 'viewskin'){
