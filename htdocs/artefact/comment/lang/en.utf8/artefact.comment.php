...
$string['messageemptynofiles'] = 'Your message is empty. Please enter a message.';
...
$string['placefeedbackbutton'] = 'Send feedback';

$string['pluginname'] = 'Comment';

$string['progress_feedback'] = array(
    0 => 'Comment on another user\'s page',
    1 => 'Comment on %s other users\' pages',
);
