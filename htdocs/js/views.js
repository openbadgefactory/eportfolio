...
(function( ViewManager, $, undefined ) {
    ...
    ViewManager.replaceConfigureBlock = function(data) {
        ...
        if (oldblock.length) {
            ...
            $('.blockinstance-header', newblock).mousedown(function() {
                    // <EKAMPUS - Bootstrap issues
                    $('#column-container>.row .column-content').each(function() {
                    // EKAMPUS>
    ...
    function init() {
        ...
        setTimeout(function() {
            ...
            // <EKAMPUS - Fix issues with .row and Bootstrap's .row
        ...
        $('.blocktype-list div.blocktype').each(function() {
            $(this).draggable({
                ...
                helper: function(event) {
                  ...
                  // <EKAMPUS - Bootstrap issues
                connectToSortable: '#column-container>.row .column .column-content',
                // EKAMPUS>
    ...
    function makeExistingBlocksSortable() {
        ...
        $('.column .column-content').sortable({
            ...
            cursorAt: {left: 5},
            // <EKAMPUS - Bootstrap issues
            connectWith: '#column-container>.row .column .column-content',
            // EKAMPUS>
    ...
    */
    ...
    function addConfigureBlock(oldblock, configblock, removeoncancel) {
        ...
        // <EKAMPUS
        // The block uses the width of the previous configure block by default.
        // Sometimes the block ends up being too narrow (like when adding
        // a text box first, and after that an image block).
        newblock.css('width', 'auto');
        // EKAMPUS>
