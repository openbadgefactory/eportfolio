...
$msgform = pieform(array(
    ...
    'elements' => array(
        'subject' => array(
            'type' => 'text',
            'title' => get_string('messagesubject', 'activity'),
            'rules' => array(
                'required' => true,
                'maxlength' => 255
            )
        ...
        'body' => array(
            'type' => 'textarea',
            'title' => get_string('messagebody', 'activity'),
            'rows' => 10,
            'cols' => 70,
            'fullwidth' => true,
            'resizable' => false,
...
// <EKAMPUS
$smarty->assign('isteacher', is_teacher());
$smarty->assign('messageform', $msgform);
// EKAMPUS>
