...
$tags = array_map('trim', explode(',', param_variable('tags', '')));
$templateid = param_integer('id', 0);

$id = PluginArtefactStudyJournal::save_template($title, $fields, $templateid,
                $tags);

json_reply(false, array('id' => $id));
