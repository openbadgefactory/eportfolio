...
function pieform_element_viewacl(Pieform $form, $element) {
    ...
    $allpresets = array('public', 'loggedin');
    // <EKAMPUS
...
//    }
    ...
    $allworkspaces = array(
        ...
        'start'  => null,
        'end'    => null,
        'name'   => get_string('allmyworkspaces', 'group'),
        'preset' => true
    );
    // EKAMPUS>
    ...
    // <EKAMPUS
    $smarty->assign('allworkspaces', json_encode($allworkspaces));
    $smarty->assign('myworkspaces', json_encode($myworkspaces));
    // EKAMPUS>
