...
abstract class PluginArtefact extends Plugin {
    ...
    /**
     * This function returns af list of classnames
...
abstract class ArtefactType {
     ...
     */
    // <EKAMPUS
    public function delete($beforedeletecallback = null) {
    // EKAMPUS>
        if (empty($this->id)) {
            $this->dirty = false;
            return;
        ...
        if (is_callable($beforedeletecallback)) {
            $beforedeletecallback($this);
        }
