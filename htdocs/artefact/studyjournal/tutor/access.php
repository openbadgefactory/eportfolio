...
requirejs(['domReady!', 'config'], function () {
    require(['../../artefact/studyjournal/js/accessmanager'], function (a) {
        a.init($templateid);
    });
});
JS;
...
$smarty->assign('PAGEHEADING', get_string('sharetemplatetitle', 'artefact.studyjournal', $template->get('title')));
$smarty->assign('template', $template);
$smarty->assign('groupaccess', $groupaccess);
$smarty->assign('institutionaccess', $institutionaccess);
$smarty->display('artefact:studyjournal:access.tpl');