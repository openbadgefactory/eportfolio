...
function TableRenderer(target, source, columns, options) {
    ...
    // <EKAMPUS
    this.clear = function () {
        self.handle_response({ limit: self.limit, offset: 0, count: 0, data: [] });
    };
    ...
    this.doupdate = function(request_args) {
        ...
        // <EKAMPUS
        // Extract response handler method.
        sendjsonrequest(self.source, request_args, 'POST', self.handle_response, null, true);
        // EKAMPUS>
    };
