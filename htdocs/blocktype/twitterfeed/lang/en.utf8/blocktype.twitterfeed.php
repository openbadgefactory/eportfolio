...
$string['colorschemedesc'] = 'Select the color scheme for the feed.';

$string['description'] = 'Add a Twitter Feed';

$string['embedcode'] = 'Embed code';

$string['list'] = 'List name (optional)';

$string['title'] = 'Embed Twitter feed';
