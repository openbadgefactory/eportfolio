...
// <EKAMPUS (formparams)
function institution_selector_for_page($institution, $page, $formparams = array(),
        $includeinstitutionstaff = false, $selectparams = array()) {
// EKAMPUS>
    ...
    // <EKAMPUS
    $institutionelement = get_institution_selector(false, false, false, $includeinstitutionstaff);

    if (!empty($institutionelement)) {
        $institutionelement = array_merge($institutionelement, $selectparams);
    }
    // EKAMPUS>
    ...
    // <EKAMPUS
    // Add own form params.
    $institutionselector = pieform(array_merge(array(
