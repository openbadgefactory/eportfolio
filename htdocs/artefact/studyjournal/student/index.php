...
$journals = PluginArtefactStudyJournal::get_journals();
...
requirejs(['domReady!', 'config'], function () {
    require(['../../artefact/studyjournal/js/studyjournal'], function (studyjournal) {
        studyjournal.init_student({ total: $count });
    });
});

JS;

$tags = ArtefactTypeStudyJournal::get_journal_tags();
$smarty = smarty(array($wwwroot . 'local/js/lib/require.js', 'lib/pieforms/static/core/pieforms.js',
    'tinymce'), array(),
        array('artefact.studyjournal' => array('confirmremovejournal')),
        array('sidebars' => false));
$smarty->assign('INLINEJAVASCRIPT', $js);
$smarty->assign('journals', $journals);
$smarty->assign('tags', $tags);
$smarty->display('artefact:studyjournal:journals.tpl');
