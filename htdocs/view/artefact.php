...
// <EKAMPUS
if (method_exists($artefact, 'get_artefact_stylesheets')) {
    foreach ($artefact->get_artefact_stylesheets() as $sheet) {
        $headers[] = '<link rel="stylesheet" type="text/css" href="' . get_config('wwwroot') . $sheet . '?v=' . get_config('release') . '">';
    }
}
// EKAMPUS>
