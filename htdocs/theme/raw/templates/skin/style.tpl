...
/*EKAMPUS*/
#container p, #container .blockinstance {
    font-family: {$view_text_font_family|safe} !important;
    font-size: {$view_text_font_size} !important;
...
.blockinstance-header .title {
    color: {$view_text_emphasized_color} !important; /*EKAMPUS*/
    font-family: {$view_heading_font_family|safe};
    border-bottom: 2px solid {$view_table_border_color} !important; /*EKAMPUS*/
}
