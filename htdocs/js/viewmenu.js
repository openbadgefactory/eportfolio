        ...
        if ($('add_feedback_link')) {
            ...
            connect('add_feedback_link', 'onclick', function(e) {
                ...
                if (typeof(feedbacklinkinblock) != 'undefined') {
                    ...
                    // <EKAMPUS
                    // Made the form overlay a bit wider.
                    formposition.x = (((getViewportDimensions().w / 2) - 340) > 0) ? (getViewportDimensions().w / 2) - 340 : 0;
                    // EKAMPUS>
                    formposition.y = 30;
                ...
                if (tinymceused) {
                    ...
                    // <EKAMPUS
                    // Prevent error when the field is missing.
                    if ($('add_feedback_form_message')) {
