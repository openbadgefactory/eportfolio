...
{if $config.upload}
{* <EKAMPUS *}
<h3 class="filebrowser-label">{if $config.simpleupload}{str tag='uploadfile' section='artefact.file'}{else}{str tag='File' section='artefact.file'}{/if}</h3>
{* EKAMPUS> *}
...
{* <EKAMPUS *}
{if ! $config.edit}
<h3 class="filebrowser-label">{str tag=addfilefrommyfiles section="artefact.file"}</h3>
{/if}
{* EKAMPUS> *}
